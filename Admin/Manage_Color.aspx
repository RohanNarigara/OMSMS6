<%@ Page Title="OMSMS | Other Details" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Manage_Color.aspx.cs" Inherits="OMSMS6.Admin.Manage_Color" %>
    ...
    <div class="p-4 space-y-10 mr-3">
        <div class="flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
            ...
            <div class="w-full p-8 lg:w-1/2">
                ...
                <p class="text-xl text-gray-600 text-center">Add Color</p>

                <%-- Add Color Form --%>
                <form id="updateColorForm" class="relative" runat="server">

                    <%-- Name --%>
                    <div class="mt-4">
                        <label class="block text-gray-700 text-sm font-bold mb-2">Color Name</label>
                        <asp:TextBox runat="server" ID="txtColor" class="bg-gray-200 text-gray-700 focus:outline-none focus:shadow-outline border border-gray-300 rounded py-2 px-4 block w-full appearance-none" />
                    </div>
