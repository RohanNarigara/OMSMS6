<%@ Page Title="OMSMS | Other Details" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Add_Color.aspx.cs" Inherits="OMSMS6.Admin.Add_Color" %>
    ...
    <div class="pl-[16%] pt-20 space-y-10">
        <div class="flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
            ...
            <div class="w-full p-8 lg:w-1/2">
                ...
                <%-- Add Color Form --%>
                <form id="addColorForm" class="relative" runat="server">
